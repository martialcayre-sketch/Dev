...
export const THEMES = [
  { prefix: 'da', label: 'Dopamine' },
  { prefix: 'na', label: 'Noradrénaline' },
  { prefix: 'se', label: 'Sérotonine' },
  { prefix: 'me', label: 'Mélatonine' },
] as const;
...
export function getQuestions(questionnaireId: string): Question[] {
  switch (questionnaireId) {
    ...
    case 'dnsm':
      // Format DNSM v2 avec 40 questions structurées (10 par neurotransmetteur)
      return [
        // ========== DOPAMINE (da-1 à da-10) ==========
        {
          id: 'da-1',
        ...
        { id: 'da-10', label: 'Je cherche souvent mes mots', type: 'select', section: 'dopamine' },

        // ========== NORADRÉNALINE (na-1 à na-10) ==========
        {
          id: 'na-1',
        ...
        { id: 'na-2', label: 'Je manque de confiance', type: 'select', section: 'noradrenaline' },
        {
          id: 'na-3',
        ...
        { id: 'me-3', label: "J'ai un sommeil « fragile »", type: 'select', section: 'melatonine' },
        {
          id: 'me-4',
