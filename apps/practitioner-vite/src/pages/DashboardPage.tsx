...
import { Activity, Brain, Sparkles, UsersRound } from 'lucide-react';
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm text-white/70">
                Retrouvez vos consultations du jour, les alertes patient, les questionnaires
                complétés et accédez à vos outils personnalisés en un seul coup d'œil.
              </p>
            </div>
